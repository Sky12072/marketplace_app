...
ActiveRecord::Schema.define(version: 2022_06_24_004907) do
  ...
  create_table "transactions", force: :cascade do |t|
    ...
    t.index ["coder_id"], name: "index_transactions_on_coder_id"
  ...
  add_foreign_key "transactions", "users", column: "coder_id"
end
